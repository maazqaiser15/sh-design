...
import { formatDateMMDDYYYY } from 'src/utils/dateUtils';
import { PROJECT_STATUS_COLORS, PROJECT_STATUS_DESCRIPTIONS, ProjectListItem } from '../../types';
import { mockProjects } from '../ProjectListPage';
...
export const ProjectDetailsComplete: React.FC<ProjectDetailsCompleteProps> = ({ projectStatus = 'Completed' }) => {
  ...
  function onProjectClick(project: any): void {
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="border-b border-gray-200 mb-6">
              <nav className="flex space-x-8">
                {[
                  ...
                  { id: 'associatedProject', label: 'Associated Project' }
            ...
            <div className='grid grid-cols-2 gap-6'>
              {activeTab === 'associatedProject' && mockProjects.slice(0,2)?.map((project: any) => (
                ...
                <Card
                  ...
                  <div className="p-4 border-b border-gray-100 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${PROJECT_STATUS_COLORS[project.status]
                            }`}>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-1 mt-1 relative">
                              {project.crew && project.crew.length > 0 ? (
                                <>
                                  {project.crew.slice(0, 2).map((member: any, index: any) => {
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center py-2 border-b border-gray-100">
                            <span className="text-sm text-gray-600">Reinstalled Film</span>
                            <span className="font-semibold text-orange-600">{projectReport.filmUsage.filmRecut} sq ft</span>
                          </div>
                          <div className="flex justify-between items-center py-2 border-b border-gray-100">
                            <span className="text-sm text-gray-600">Reinstalled Film Percentage</span>
