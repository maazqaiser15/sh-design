...
const mockProjects: SafeHavenProject[] = [
  ...
  },
  {
    ...
    description:
      "Security film installation for newly constructed office building",
    status: "WIP",
    stage: "WIP",
  ...
  // Archived projects
  {
    ...
    description:
      "Security film installation for old office building (archived)",
    status: "Archived",
    stage: "Archived",
...
export const ProjectListPage: React.FC = () => {
  ...
  const [projectForDateAssignment, setProjectForDateAssignment] =
    useState<ProjectListItem | null>(null);
  const [showLeadSupervisorAnalytics, setShowLeadSupervisorAnalytics] =
    useState(true);
  const [isCoordinatorModalOpen, setIsCoordinatorModalOpen] = useState(false);
  const [projectForCoordinatorAssignment, setProjectForCoordinatorAssignment] =
    useState<ProjectListItem | null>(null);
  ...
  const handleAssignCoordinator = (
    ...
    console.log(
      `Assigning coordinator ${coordinatorId} to project ${projectId}`
    );
    if (startDate) {
  ...
  const handleDateConfirm = (startDate: string, endDate: string) => {
    if (projectForDateAssignment) {
      ...
      console.log(
        `Setting dates for project ${projectForDateAssignment.title}:`,
        { startDate, endDate }
      );
            ...
            <nav className="flex space-x-1 gap-3  border-b border-b-gray-300 w-fit">
              {[
                ...
                <button
                  ...
                  onClick={() => {
                    const projectStatus =
                      status === "All" ? "" : (status as ProjectStatus);
                    setFilters({
              ...
              {isLeadSupervisor && (
                <div className="flex items-center gap-2 mb-2 sm:mb-0">
                  <Button
                    ...
                    icon={BarChart3}
                    onClick={() =>
                      setShowLeadSupervisorAnalytics(
                        !showLeadSupervisorAnalytics
                      )
                    }>
                    Analytics
                  </Button>
              ...
              <Card className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {leadSupervisorAnalytics.totalProjects}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600">
                      {leadSupervisorAnalytics.activeProjects}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {leadSupervisorAnalytics.completionRate.toFixed(1)}%
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">
                      {leadSupervisorAnalytics.averageProgress.toFixed(1)}%
                    </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.entries(
                      leadSupervisorAnalytics.projectsByStatus
                    ).map(([status, count]) => (
                      <div
                        key={status}
