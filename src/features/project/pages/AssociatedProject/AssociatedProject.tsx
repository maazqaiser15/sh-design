...
import { Calendar, CheckCircle2, Edit, Eye, MinusCircle, MoreVertical, Phone, PlusCircle, Subtitles, Trash2, User } from 'lucide-react'
...
const AssociatedProject = () => {
    ...
    return (
        <div className='p-4'>
            <div className="flex justify-between mb-4 gap-3 pt-4 border-t border-gray-200">
                <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Create Associate Project</h1>
