...
export const AddHotelReservationModal: React.FC<AddHotelReservationModalProps> = ({
  ...
  const validateForm = () => {
    ...
    if (reservationDetails.hotelCost < 0) {
      newErrors.hotelCost = 'Hotel cost cannot be negative';
    }
    ...
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          {/* Hotel Cost */}
          <div>
            <label htmlFor="hotelCost" className="block text-sm font-medium text-gray-700 mb-1">
              Hotel Cost *
            </label>
            <div className="relative">
              ...
              <input
                ...
                min="0"
                step="0.01"
                value={reservationDetails.hotelCost}
                ...
                className={`w-full pl-8 pr-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.hotelCost ? 'border-red-300' : 'border-gray-300'
                }`}
                placeholder="0.00"
              />
            </div>
            {errors.hotelCost && (
              <p className="mt-1 text-sm text-red-600">{errors.hotelCost}</p>
            )}
          </div>
