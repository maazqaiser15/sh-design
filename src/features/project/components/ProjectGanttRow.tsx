...
import { ProjectGanttBar } from './ProjectGanttBar';
...
interface ProjectGanttRowProps {
  ...
  currentDate: Date;
  onProjectHover: (project: ProjectListItem | null) => void;
  onProjectClick: (project: ProjectListItem) => void;
  hoveredProject: ProjectListItem | null;
}

export const ProjectGanttRow: React.FC<ProjectGanttRowProps> = ({
  project,
  viewMode,
  currentDate,
  onProjectHover,
  ...
  return (
    <div className="flex border-b border-gray-200 hover:bg-gray-50 transition-colors">
      ...
      <div className="w-72 p-3 flex-shrink-0 border-r border-gray-200">
