...
export const TeamGanttWithViews: React.FC<TeamGanttProps> = ({
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 rounded-lg">
      ...
      {/* Fixed Legend */}
      <div className={`fixed bottom-0 ${isCollapsed ? 'left-[80px]' : 'left-[272px]'} right-[16px] bg-white border-t border-gray-200 p-4 shadow-lg z-50 transition-all duration-300`}>
